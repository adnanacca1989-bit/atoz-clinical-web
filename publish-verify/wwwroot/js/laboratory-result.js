document.addEventListener('DOMContentLoaded', () => {
    ...
    const patientNameInput = document.getElementById('labResultPatientNameInput');
    ...
    const loadLabRequest = async (patient) => {
        ...
        try {
            ...
            const res = await fetch(`/Laboratory/RequestByPatient?${params}`);
