...
public class OwnerModel : SettingsFormPageModel
{
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        else if (Records.Count > 0 && Input.OwnerNo == 0) await LoadRecord(clinicId.Value, Records[0].Id);
    ...
    private async Task<IActionResult> SaveCoreAsync()
    {
        ...
        var saved = await _lookup.SaveOwnerAsync(clinicId.Value, Input.ToEntity(RecordId), UserName);
