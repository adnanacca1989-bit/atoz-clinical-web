...
public class PatientHistoryModel : PageModel
{
    ...
    private async Task<IActionResult> RunSearchAsync()
    {
        ...
        foreach (var rx in await _db.Prescriptions.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var inv in await _db.Invoices.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var lr in await _db.LabRequests.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var lr in await _db.LabResults.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var rr in await _db.RadiologyRequests.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var rr in await _db.RadiologyResults.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var pr in await _db.PharmacyRequests.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var pb in await _db.PharmacyBills.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var sir in await _db.ServiceIncomeRequests.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var cr in await _db.CashReceipts.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
        ...
        foreach (var cp in await _db.CashPayments.Where(x => x.ClinicId == clinicId).Apply(_doctorScope.Filter).ToListAsync())
