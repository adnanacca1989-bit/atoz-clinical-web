...
public sealed class ClinicSettingsService
{
    ...
    public ClinicSettingsService(ClinicalDbContext db, UserManager<ApplicationUser> users)
    {
        _db = db;
        _users = users;
    }

    public async Task<ClinicConfiguration> GetOrCreateAsync(Guid clinicId)
    {
