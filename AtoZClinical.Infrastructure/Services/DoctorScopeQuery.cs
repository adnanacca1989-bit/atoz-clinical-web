...
public static class DoctorScopeQuery
{
    ...
    public static IQueryable<DoctorSurgery> Apply(this IQueryable<DoctorSurgery> query, DoctorScopeFilter scope) =>
        ApplyDoctor(query, scope, s => s.DoctorRecordId, s => s.DoctorName);
